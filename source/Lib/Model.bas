...
Public Sub Create (Category As Int, Code As String, Name As String, Created_Date As String)
	DB.Open
	DB.Table = "tbl_$endpoints$"
	DB.Columns = Array("category_id", "$endpoint$_code", "$endpoint$_name", "created_date")
	DB.Parameters = Array(Category, Code, Name, Created_Date)
	DB.ReturnRow = True
	DB.Save
End Sub
...
Public Sub Update (Id As Int, Category As Int, Code As String, Name As String, Modified_Date As String)
	DB.Open
	DB.Table = "tbl_$endpoints$"
	DB.Columns = Array("category_id", "$endpoint$_code", "$endpoint$_name", "modified_date")
	DB.Parameters = Array(Category, Code, Name, Modified_Date)
	DB.Condition = "id = ?"
	DB.Parameter = Id
	DB.ReturnRow = True
	DB.Save
