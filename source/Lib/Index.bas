...
Public Sub GeneratePage As String
    Dim html1 As MiniHtml = Helper_Module.Html
    'html1.comment2(" Generated by MiniHTML3 ", True)
    html1.comment(" Generated by MiniHTML3 ")
    Dim head1 As MiniHtml = Helper_Module.Head.up(html1)
	head1.SpecialTags = Array As String("") 'indent
    Dim meta1 As MiniHtml = Helper_Module.Meta.up(head1)
    meta1.attr("charset", "UTF-8")
    Dim meta2 As MiniHtml = Helper_Module.Meta.up(head1)
    meta2.attr("name", "viewport")
    meta2.attr("content", "width=device-width, initial-scale=1")
    Dim title1 As MiniHtml = Helper_Module.Title.up(head1)
    ...
    Dim body1 As MiniHtml = Helper_Module.Body.up(html1)
	body1.SpecialTags = Array As String("") 'indent
    Dim div1 As MiniHtml = Helper_Module.Div.up(body1)
    div1.cls("d-flex align-items-center")
    div1.sty("height: 100vh")
    Dim div2 As MiniHtml = Helper_Module.Div.up(div1)
    div2.sty("margin: auto")
    Dim div3 As MiniHtml = Helper_Module.Div.up(div2)
    ...
    Dim div4 As MiniHtml = Helper_Module.Div.up(div3)
    div4.cls("modal-dialog modal-lg modal-dialog-centered")
    div4.attr("role", "document")
    Dim div5 As MiniHtml = Helper_Module.Div.up(div4)
    div5.cls("modal-content")
    Dim button1 As MiniHtml = Helper_Module.Button.up(div2)
...
Sub GenerateModal As String
    Dim div1 As MiniHtml = Helper_Module.Div
    div1.cls("modal-dialog modal-lg modal-dialog-centered")
    Dim div2 As MiniHtml = Helper_Module.Div.up(div1)
    div2.cls("modal-content")
    Dim div3 As MiniHtml = Helper_Module.Div.up(div2)
    div3.cls("modal-header")
    Dim h51 As MiniHtml = Helper_Module.H5.up(div3)
    h51.cls("modal-title")
    h51.text("Modal title")
    Dim div4 As MiniHtml = Helper_Module.Div.up(div2)
    div4.cls("modal-body")
    Dim p1 As MiniHtml = Helper_Module.P.up(div4)
    p1.text("Modal body text goes here.")
    Dim div5 As MiniHtml = Helper_Module.Div.up(div2)
    div5.cls("modal-footer")
    Dim button1 As MiniHtml = Helper_Module.Button.up(div5)
